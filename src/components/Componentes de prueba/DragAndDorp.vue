  ...
  export default {
    ...
    methods: {
      ...
      onDrop(event, targetItem) {
        ...
        const draggedIndex = this.pokeData.findIndex(pokemon => pokemon.name === draggedItem.name);
        const targetIndex = this.pokeData.findIndex(pokemon => pokemon.name === targetItem.name);
